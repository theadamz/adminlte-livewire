...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'access.menus.6.path' => 'NULL',
            'access.menus.6.icon' => 'string',
            'access.menus.6.visible' => 'boolean',
            'access.menus.6.children.0.group_code' => 'string',
            'access.menus.6.children.0.parent_menu_code' => 'string',
            'access.menus.6.children.0.code' => 'string',
            'access.menus.6.children.0.name' => 'string',
            'access.menus.6.children.0.description' => 'string',
            'access.menus.6.children.0.path' => 'string',
            'access.menus.6.children.0.icon' => 'string',
            'access.menus.6.children.0.visible' => 'boolean',
            'access.menus.6.children.0.children' => 'NULL',
            'access.menus.6.children.1.group_code' => 'string',
            'access.menus.6.children.1.parent_menu_code' => 'string',
            'access.menus.6.children.1.code' => 'string',
            'access.menus.6.children.1.name' => 'string',
            'access.menus.6.children.1.description' => 'string',
            'access.menus.6.children.1.path' => 'string',
            'access.menus.6.children.1.icon' => 'string',
            'access.menus.6.children.1.visible' => 'boolean',
            'access.menus.6.children.1.children' => 'NULL',
            'access.menus.6.children.2.group_code' => 'string',
            'access.menus.6.children.2.parent_menu_code' => 'string',
            'access.menus.6.children.2.code' => 'string',
            'access.menus.6.children.2.name' => 'string',
            'access.menus.6.children.2.description' => 'string',
            'access.menus.6.children.2.path' => 'string',
            'access.menus.6.children.2.icon' => 'string',
            'access.menus.6.children.2.visible' => 'boolean',
            'access.menus.6.children.2.children' => 'NULL',
            'access.menus.6.children.3.group_code' => 'string',
            'access.menus.6.children.3.parent_menu_code' => 'string',
            'access.menus.6.children.3.code' => 'string',
            'access.menus.6.children.3.name' => 'string',
            'access.menus.6.children.3.description' => 'string',
            'access.menus.6.children.3.path' => 'string',
            'access.menus.6.children.3.icon' => 'string',
            'access.menus.6.children.3.visible' => 'boolean',
            'access.menus.6.children.3.children' => 'NULL',
            'access.roleList.0.code' => 'string',
            'access.roleList.0.name' => 'string',
            'access.roleList.0.permissions' => 'array',
            'access.roleList.1.code' => 'string',
            'access.roleList.1.name' => 'string',
            'access.roleList.1.permissions' => 'array',
            'access.roleList.2.code' => 'string',
            'access.roleList.2.name' => 'string',
            'access.roleList.2.permissions' => 'array',
            'access.roleList.3.code' => 'string',
            'access.roleList.3.name' => 'string',
            'access.roleList.3.permissions' => 'array',
            'access.roleList.4.code' => 'string',
            'access.roleList.4.name' => 'string',
            'access.roleList.4.permissions' => 'array',
            'access.roleList.5.code' => 'string',
            'access.roleList.5.name' => 'string',
            'access.roleList.5.permissions' => 'array',
            'access.roleList.6.code' => 'string',
            'access.roleList.6.name' => 'string',
            'access.roleList.6.permissions' => 'array',
            'access.roleList.7.code' => 'string',
            'access.roleList.7.name' => 'string',
            'access.roleList.7.permissions' => 'array',
            'access.roleList.8.code' => 'string',
            'access.roleList.8.name' => 'string',
            'access.roleList.8.permissions' => 'array',
            'access.roleList.9.code' => 'string',
            'access.roleList.9.name' => 'string',
            'access.roleList.9.permissions' => 'array',
            'access.roleList.10.code' => 'string',
            'access.roleList.10.name' => 'string',
            'access.roleList.10.permissions' => 'array',
            'access.roleList.11.code' => 'string',
            'access.roleList.11.name' => 'string',
            'access.roleList.11.permissions' => 'array',
            'access.userList.0.code' => 'string',
            'access.userList.0.name' => 'string',
            'access.userList.0.permissions' => 'array',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
            ...
            'filesystems.links.D:\laragon\www\adminlte-livewire\public\storage' => 'string',
            ...
            'setting.local.js_datetime_format_mask' => 'string',
            'setting.local.js_date_format_mask' => 'string',
            'setting.local.js_time_format_mask' => 'string',
            ...
            'setting.other.path_to_template' => 'string',
            'setting.other.cache_time' => 'integer',
            ...
            'setting.regxp.forHexColor' => 'string',
            'setting.data.day_names' => 'array',
            'setting.data.seconds_one_day' => 'integer',
...
'access.userIdExceptions','access.roleIdExceptions','access.groups.0.code','access.groups.0.name','access.groups.0.visible',
'access.groups.1.code','access.groups.1.name','access.groups.1.visible','access.menus.0.group_code','access.menus.0.parent_menu_code',
'access.menus.0.code','access.menus.0.name','access.menus.0.description','access.menus.0.path','access.menus.0.icon',
'access.menus.0.visible','access.menus.0.children','access.menus.1.group_code','access.menus.1.parent_menu_code','access.menus.1.code',
'access.menus.1.name','access.menus.1.description','access.menus.1.path','access.menus.1.icon','access.menus.1.visible',
'access.menus.1.children','access.menus.2.group_code','access.menus.2.parent_menu_code','access.menus.2.code','access.menus.2.name',
'access.menus.2.description','access.menus.2.path','access.menus.2.icon','access.menus.2.visible','access.menus.2.children',
'access.menus.3.group_code','access.menus.3.parent_menu_code','access.menus.3.code','access.menus.3.name','access.menus.3.description',
'access.menus.3.path','access.menus.3.icon','access.menus.3.visible','access.menus.3.children','access.menus.4.group_code',
'access.menus.4.parent_menu_code','access.menus.4.code','access.menus.4.name','access.menus.4.description','access.menus.4.path',
'access.menus.4.icon','access.menus.4.visible','access.menus.4.children','access.menus.5.group_code','access.menus.5.parent_menu_code',
'access.menus.5.code','access.menus.5.name','access.menus.5.description','access.menus.5.path','access.menus.5.icon',
'access.menus.5.visible','access.menus.5.children','access.menus.6.group_code','access.menus.6.parent_menu_code','access.menus.6.code',
'access.menus.6.name','access.menus.6.description','access.menus.6.path','access.menus.6.icon','access.menus.6.visible',
'access.menus.6.children.0.group_code','access.menus.6.children.0.parent_menu_code','access.menus.6.children.0.code','access.menus.6.children.0.name','access.menus.6.children.0.description',
'access.menus.6.children.0.path','access.menus.6.children.0.icon','access.menus.6.children.0.visible','access.menus.6.children.0.children','access.menus.6.children.1.group_code',
'access.menus.6.children.1.parent_menu_code','access.menus.6.children.1.code','access.menus.6.children.1.name','access.menus.6.children.1.description','access.menus.6.children.1.path',
'access.menus.6.children.1.icon','access.menus.6.children.1.visible','access.menus.6.children.1.children','access.menus.6.children.2.group_code','access.menus.6.children.2.parent_menu_code',
'access.menus.6.children.2.code','access.menus.6.children.2.name','access.menus.6.children.2.description','access.menus.6.children.2.path','access.menus.6.children.2.icon',
'access.menus.6.children.2.visible','access.menus.6.children.2.children','access.menus.6.children.3.group_code','access.menus.6.children.3.parent_menu_code','access.menus.6.children.3.code',
'access.menus.6.children.3.name','access.menus.6.children.3.description','access.menus.6.children.3.path','access.menus.6.children.3.icon','access.menus.6.children.3.visible',
'access.menus.6.children.3.children','access.roleList.0.code','access.roleList.0.name','access.roleList.0.permissions','access.roleList.1.code',
'access.roleList.1.name','access.roleList.1.permissions','access.roleList.2.code','access.roleList.2.name','access.roleList.2.permissions',
'access.roleList.3.code','access.roleList.3.name','access.roleList.3.permissions','access.roleList.4.code','access.roleList.4.name',
'access.roleList.4.permissions','access.roleList.5.code','access.roleList.5.name','access.roleList.5.permissions','access.roleList.6.code',
'access.roleList.6.name','access.roleList.6.permissions','access.roleList.7.code','access.roleList.7.name','access.roleList.7.permissions',
'access.roleList.8.code','access.roleList.8.name','access.roleList.8.permissions','access.roleList.9.code','access.roleList.9.name',
'access.roleList.9.permissions','access.roleList.10.code','access.roleList.10.name','access.roleList.10.permissions','access.roleList.11.code',
'access.roleList.11.name','access.roleList.11.permissions','access.userList.0.code','access.userList.0.name','access.userList.0.permissions',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\adminlte-livewire\\public\\storage',
...
'session.partitioned','setting.general.web_name','setting.general.web_name_short','setting.general.web_description','setting.general.web_keywords',
'setting.general.web_author','setting.general.web_email','setting.general.company_name','setting.general.company_name_short','setting.general.version',
'setting.general.copyright','setting.local.charset','setting.local.locale','setting.local.locale_short','setting.local.locale_long',
'setting.local.timezone','setting.local.country','setting.local.numeric_thousand_separator','setting.local.numeric_decimal_separator','setting.local.numeric_precision_length',
'setting.local.js_datetime_format','setting.local.js_date_format','setting.local.js_time_format','setting.local.js_datetime_format_mask','setting.local.js_date_format_mask',
'setting.local.js_time_format_mask','setting.local.jasper_format_datetime','setting.local.jasper_format_date','setting.local.jasper_format_time','setting.local.jasper_format_integer',
'setting.local.jasper_format_float','setting.local.jasper_format_number','setting.local.backend_datetime_format','setting.local.backend_date_format','setting.local.backend_time_format',
'setting.other.max_file_attachment','setting.other.max_file_size','setting.other.file_doc_attachment_allowed','setting.other.file_img_allowed','setting.other.path_to_upload',
'setting.other.path_to_temp','setting.other.path_to_template','setting.other.cache_time','setting.page.limits','setting.page.default_limit',
'setting.sequence.year_format','setting.sequence.month_format','setting.sequence.array_format.prefix','setting.sequence.array_format.suffix','setting.sequence.array_format.year',
'setting.sequence.array_format.month','setting.sequence.array_format.seq','setting.sequence.format_seq_default','setting.method.allowed','setting.regxp.forCode',
'setting.regxp.forUsername','setting.regxp.forTransType','setting.regxp.forHexColor','setting.data.day_names','setting.data.seconds_one_day',
...
'livewire.preview-file','home','dashboard','login',
'register','password.request','verification.notice','verification.verify','password.confirm',
'logout','storage.local',);
        registerArgumentsSet('views', 
'components.layouts.app','components.layouts.guest','components.widgets.loading-overlay','livewire.auth.confirm-password','livewire.auth.forgot-password',
'livewire.auth.login','livewire.auth.register','livewire.auth.verify-email','livewire.dashboard','welcome',
