...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\adminlte-livewire\\public\\storage','livewire.class_namespace','livewire.view_path',
...
'session.secure','session.http_only','session.same_site','session.partitioned','setting.general.web_name',
'setting.general.web_name_short','setting.general.web_description','setting.general.web_keywords','setting.general.web_author','setting.general.web_email',
'setting.general.company_name','setting.general.company_name_short','setting.general.version','setting.general.copyright','setting.local.charset',
'setting.local.locale','setting.local.locale_short','setting.local.locale_long','setting.local.timezone','setting.local.country',
'setting.local.numeric_thousand_separator','setting.local.numeric_decimal_separator','setting.local.numeric_precision_length','setting.local.js_datetime_format','setting.local.js_date_format',
'setting.local.js_time_format','setting.local.js_datetime_format_mask','setting.local.js_date_format_mask','setting.local.js_time_format_mask','setting.local.jasper_format_datetime',
'setting.local.jasper_format_date','setting.local.jasper_format_time','setting.local.jasper_format_integer','setting.local.jasper_format_float','setting.local.jasper_format_number',
'setting.local.backend_datetime_format','setting.local.backend_date_format','setting.local.backend_time_format','setting.other.max_file_attachment','setting.other.max_file_size',
'setting.other.file_doc_attachment_allowed','setting.other.file_img_allowed','setting.other.path_to_upload','setting.other.path_to_temp','setting.other.path_to_template',
'setting.other.cache_time','setting.page.limits','setting.page.default_limit','setting.sequence.year_format','setting.sequence.month_format',
'setting.sequence.array_format.prefix','setting.sequence.array_format.suffix','setting.sequence.array_format.year','setting.sequence.array_format.month','setting.sequence.array_format.seq',
'setting.sequence.format_seq_default','setting.method.allowed','setting.regxp.forCode','setting.regxp.forUsername','setting.regxp.forTransType',
'setting.regxp.forHexColor','setting.data.day_names','setting.data.seconds_one_day','broadcasting.default','broadcasting.connections.reverb.driver',
...
'livewire.preview-file','login','register',
'password.request','storage.local',);
        registerArgumentsSet('views', 
'components.layouts.app','components.layouts.guest','livewire.auth.forgot-password','livewire.auth.login','livewire.auth.register',
