...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            'access.user_id_exceptions' => 'array',
            ...
            'access.access_list.0.code' => 'string',
            'access.access_list.0.name' => 'string',
            'access.access_list.0.permissions' => 'array',
            'access.access_list.1.code' => 'string',
            'access.access_list.1.name' => 'string',
            'access.access_list.1.permissions' => 'array',
            'access.access_list.2.code' => 'string',
            'access.access_list.2.name' => 'string',
            'access.access_list.2.permissions' => 'array',
            'access.access_list.3.code' => 'string',
            'access.access_list.3.name' => 'string',
            'access.access_list.3.permissions' => 'array',
            'access.access_list.4.code' => 'string',
            'access.access_list.4.name' => 'string',
            'access.access_list.4.permissions' => 'array',
            'access.access_list.5.code' => 'string',
            'access.access_list.5.name' => 'string',
            'access.access_list.5.permissions' => 'array',
            'access.access_list.6.code' => 'string',
            'access.access_list.6.name' => 'string',
            'access.access_list.6.permissions' => 'array',
            'access.access_list.7.code' => 'string',
            'access.access_list.7.name' => 'string',
            'access.access_list.7.permissions' => 'array',
            'access.access_list.8.code' => 'string',
            'access.access_list.8.name' => 'string',
            'access.access_list.8.permissions' => 'array',
            'access.access_list.9.code' => 'string',
            'access.access_list.9.name' => 'string',
            'access.access_list.9.permissions' => 'array',
            'access.access_list.10.code' => 'string',
            'access.access_list.10.name' => 'string',
            'access.access_list.10.permissions' => 'array',
            'access.access_list.11.code' => 'string',
            'access.access_list.11.name' => 'string',
            'access.access_list.11.permissions' => 'array',
            'app.name' => 'string',
            'app.env' => 'string',
            'app.debug' => 'boolean',
            'app.url' => 'string',
...
'access.user_id_exceptions','access.groups.0.code','access.groups.0.name','access.groups.0.visible','access.groups.1.code',
'access.groups.1.name','access.groups.1.visible','access.menus.0.group_code','access.menus.0.parent_menu_code','access.menus.0.code',
'access.menus.0.name','access.menus.0.description','access.menus.0.path','access.menus.0.icon','access.menus.0.visible',
'access.menus.0.children','access.menus.1.group_code','access.menus.1.parent_menu_code','access.menus.1.code','access.menus.1.name',
'access.menus.1.description','access.menus.1.path','access.menus.1.icon','access.menus.1.visible','access.menus.1.children',
'access.menus.2.group_code','access.menus.2.parent_menu_code','access.menus.2.code','access.menus.2.name','access.menus.2.description',
'access.menus.2.path','access.menus.2.icon','access.menus.2.visible','access.menus.2.children','access.menus.3.group_code',
'access.menus.3.parent_menu_code','access.menus.3.code','access.menus.3.name','access.menus.3.description','access.menus.3.path',
'access.menus.3.icon','access.menus.3.visible','access.menus.3.children','access.menus.4.group_code','access.menus.4.parent_menu_code',
'access.menus.4.code','access.menus.4.name','access.menus.4.description','access.menus.4.path','access.menus.4.icon',
'access.menus.4.visible','access.menus.4.children','access.menus.5.group_code','access.menus.5.parent_menu_code','access.menus.5.code',
'access.menus.5.name','access.menus.5.description','access.menus.5.path','access.menus.5.icon','access.menus.5.visible',
'access.menus.5.children','access.menus.6.group_code','access.menus.6.parent_menu_code','access.menus.6.code','access.menus.6.name',
'access.menus.6.description','access.menus.6.path','access.menus.6.icon','access.menus.6.visible','access.menus.6.children.0.group_code',
'access.menus.6.children.0.parent_menu_code','access.menus.6.children.0.code','access.menus.6.children.0.name','access.menus.6.children.0.description','access.menus.6.children.0.path',
'access.menus.6.children.0.icon','access.menus.6.children.0.visible','access.menus.6.children.0.children','access.menus.6.children.1.group_code','access.menus.6.children.1.parent_menu_code',
'access.menus.6.children.1.code','access.menus.6.children.1.name','access.menus.6.children.1.description','access.menus.6.children.1.path','access.menus.6.children.1.icon',
'access.menus.6.children.1.visible','access.menus.6.children.1.children','access.menus.6.children.2.group_code','access.menus.6.children.2.parent_menu_code','access.menus.6.children.2.code',
'access.menus.6.children.2.name','access.menus.6.children.2.description','access.menus.6.children.2.path','access.menus.6.children.2.icon','access.menus.6.children.2.visible',
'access.menus.6.children.2.children','access.access_list.0.code','access.access_list.0.name','access.access_list.0.permissions','access.access_list.1.code',
'access.access_list.1.name','access.access_list.1.permissions','access.access_list.2.code','access.access_list.2.name','access.access_list.2.permissions',
'access.access_list.3.code','access.access_list.3.name','access.access_list.3.permissions','access.access_list.4.code','access.access_list.4.name',
'access.access_list.4.permissions','access.access_list.5.code','access.access_list.5.name','access.access_list.5.permissions','access.access_list.6.code',
'access.access_list.6.name','access.access_list.6.permissions','access.access_list.7.code','access.access_list.7.name','access.access_list.7.permissions',
'access.access_list.8.code','access.access_list.8.name','access.access_list.8.permissions','access.access_list.9.code','access.access_list.9.name',
'access.access_list.9.permissions','access.access_list.10.code','access.access_list.10.name','access.access_list.10.permissions','access.access_list.11.code',
'access.access_list.11.name','access.access_list.11.permissions','app.name','app.env','app.debug',
...
'filesystems.disks.s3.report','filesystems.links.D:\\laragon\\www\\adminlte-livewire\\public\\storage','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'session.http_only','session.same_site','session.partitioned','setting.general.web_name','setting.general.web_name_short',
'setting.general.web_description','setting.general.web_keywords','setting.general.web_author','setting.general.web_email','setting.general.company_name',
'setting.general.company_name_short','setting.general.version','setting.general.copyright','setting.local.charset','setting.local.locale',
'setting.local.locale_short','setting.local.locale_long','setting.local.timezone','setting.local.country','setting.local.numeric_thousand_separator',
'setting.local.numeric_decimal_separator','setting.local.numeric_precision_length','setting.local.js_datetime_format','setting.local.js_date_format','setting.local.js_time_format',
'setting.local.js_datetime_format_mask','setting.local.js_date_format_mask','setting.local.js_time_format_mask','setting.local.jasper_format_datetime','setting.local.jasper_format_date',
'setting.local.jasper_format_time','setting.local.jasper_format_integer','setting.local.jasper_format_float','setting.local.jasper_format_number','setting.local.backend_datetime_format',
'setting.local.backend_date_format','setting.local.backend_time_format','setting.other.max_file_attachment','setting.other.max_file_size','setting.other.file_doc_attachment_allowed',
'setting.other.file_img_allowed','setting.other.path_to_upload','setting.other.path_to_temp','setting.other.path_to_template','setting.other.cache_time',
'setting.page.limits','setting.page.default_limit','setting.sequence.year_format','setting.sequence.month_format','setting.sequence.array_format.prefix',
'setting.sequence.array_format.suffix','setting.sequence.array_format.year','setting.sequence.array_format.month','setting.sequence.array_format.seq','setting.sequence.format_seq_default',
'setting.method.allowed','setting.regxp.forCode','setting.regxp.forUsername','setting.regxp.forTransType','setting.regxp.forHexColor',
'setting.data.day_names','setting.data.seconds_one_day','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'dashboard','login','register','password.request','password.reset',
'verification.notice','verification.verify','password.confirm','logout','storage.local',);
        registerArgumentsSet('views', 
'components.forms.logout','components.layouts.app','components.layouts.app._sidebar','components.layouts.guest','components.widgets.loading-overlay',
...
'livewire.auth.verify-email','livewire.dashboard','livewire.placeholder','livewire.setting.profile','partials.app._footer',
'partials.app._navbar','partials.app._preloader','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
